...
<div class='wp-openapi-callback-info-html-value'><?php echo $callable[0]?></div>
...
<div class='wp-openapi-callback-info-html-value'><?php echo $callable[1]?></div>
<?php } ?>

<?php if ($filepath) { ?>
<div class='wp-openapi-callback-info-html-label'>Filepath</div>
<div class='wp-openapi-callback-info-html-value'><?php echo $filepath?></div>
<?php } ?>
</div>
