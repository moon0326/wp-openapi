...
<div class='wp-openapi-callback-info-html-value'><?=$callable[0]?></div>
...
<div class='wp-openapi-callback-info-html-value'><?=$callable[1]?></div>
<?php } ?>

<?php if ($filepath) { ?>
<div class='wp-openapi-callback-info-html-label'>Filepath</div>
<div class='wp-openapi-callback-info-html-value'><?=$filepath?></div>
<?php } ?>
</div>
